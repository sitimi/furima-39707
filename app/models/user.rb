class User < ApplicationRecord
  ...
  validates :last_name_cn, format: { with: /\A[ぁ-んァ-ン一-龥々ー]/, message: "は全角ひらがな、全角カタカナ、漢字で入力して下さい" }, presence: true
  validates :first_name_cn,format: { with: /\A[ぁ-んァ-ン一-龥々ー]/, message: "は全角ひらがな、全角カタカナ、漢字で入力して下さい" }, presence: true
